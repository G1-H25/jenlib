...
#ifndef INCLUDE_JENLIB_TIME_DRIVERS_ESPIDFTIMEDRIVER_H_
#define INCLUDE_JENLIB_TIME_DRIVERS_ESPIDFTIMEDRIVER_H_
...
#endif  // INCLUDE_JENLIB_TIME_DRIVERS_ESPIDFTIMEDRIVER_H_
