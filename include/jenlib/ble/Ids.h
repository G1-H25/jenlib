...
class SessionId {
 public:
    SessionId() : value_(0) {}
    explicit SessionId(std::uint32_t value) : value_(value) {}
    std::uint32_t value() const { return value_; }
    friend bool operator==(SessionId a, SessionId b) { return a.value_ == b.value_; }
 private:
...
class DeviceId {
 public:
    DeviceId() : value_(0) {}
    explicit DeviceId(std::uint32_t value) : value_(value) {}
    std::uint32_t value() const { return value_; }
    friend bool operator==(DeviceId a, DeviceId b) { return a.value_ == b.value_; }
