...
#ifndef INCLUDE_JENLIB_BLE_DRIVERS_ESPIDF_BLEDRIVER_H_
#define INCLUDE_JENLIB_BLE_DRIVERS_ESPIDF_BLEDRIVER_H_
...
#endif  // INCLUDE_JENLIB_BLE_DRIVERS_ESPIDF_BLEDRIVER_H_
