...
#ifndef INCLUDE_JENLIB_ONEWIRE_DRIVERS_ESPIDF_ONEWIREBUS_H_
#define INCLUDE_JENLIB_ONEWIRE_DRIVERS_ESPIDF_ONEWIREBUS_H_
...
#endif  // INCLUDE_JENLIB_ONEWIRE_DRIVERS_ESPIDF_ONEWIREBUS_H_
